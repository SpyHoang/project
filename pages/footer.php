<footer class="footer">
        ...
        <div class="grid__row">
            <div class="col l-2-4 m-4 c-6">
                ...
                <ul class="footer-list">
                    ...
                    <li class="footer-item">
                        <a href="#" class="footer-item__link">Chợ Phiên Mall</a>
                    </li>
                    <li class="footer-item">
            ...
            <div class="col l-2-4 m-8 c-6">
                ...
                <div class="footer__download">
                    <img src="images/qrcode.png" class="footer__download-qr">
                    <div class="footer__download-apps">
                        <a href="#" class="footer__download-app-link">
                            <img src="images/ch_play.png" class="footer__download-app-img">
                        </a>

                        <a href="#" class="footer__download-app-link">
                            <img src="images/apstore.png" class="footer__download-app-img">
                        </a>
                    </div>
                </div>
    ...
    <div class="footer__bottom">
        <div class="grid wide">
            <p class="footer__text">@2020 - Bản quyền thuộc về Công ty Chợ Phiên</p>
        </div>
    </div>
</footer>